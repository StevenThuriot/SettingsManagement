...
namespace SettingsManagement
{
    ...
    public sealed partial class SettingsContext : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public SettingsContext BeginChildScope(string name = null, IConfigurationManager configurationManager = null) => new SettingsContext(name, this, configurationManager);
        ...
        /// <returns></returns>
        public static SettingsContext Set(SettingsContext context) => new SettingsContext(context._scopeName, context, context._defaultConfigurationManager);
